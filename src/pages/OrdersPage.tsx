          ...
          <div className="lg:col-span-4">
            <div className="rounded-2xl h-full border border-gray-100 bg-gradient-to-br from-white to-gray-50 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col justify-between">
              <div className="p-4 sm:p-5">
                ...
                <div
                  className="mt-3 block text-right font-bold text-purple-700 truncate whitespace-nowrap text-xl tabular-nums"
                  title={formatCurrency(totalPaidAmount)}
                >
                    ...
                    sortedOrders.map((order) => (
                      ...
                      >
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="mt-1 text-xs text-gray-600 md:hidden">
                              {order.gross_amount
                                ...
                                : "N/A"}{" "}
                              •{" "}
                              {safeReplace(order.payment_type || "-", "_", " ")}
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="hidden lg:table-cell">
                          <div className="flex flex-col">
                            <div className="text-sm font-medium text-gray-900">
                              {order.kelas?.name || "N/A"}
                            </div>
                            <div className="text-sm text-gray-500">
                              {order.kelas?.price
                                ? formatCurrency(order.kelas.price)
                                : "N/A"}
                            </div>
                          </div>
                        </td>
                ...
                <div className="flex items-center gap-1">
                  ...
                  {getPageNumbers(currentPage, totalPages).map((p, idx) => (
                    <button
                      ...
                      disabled={p === "…"}
                      className={`btn btn-secondary ${p === currentPage ? "!bg-[color:var(--accent)] !text-white border-[color:var(--accent)]" : ""}`}
                    >
                      {p}
                    </button>
                  ))}
